...
const FormPopup = ({ isOpen, onClose, onNext, ...props }) => {
  ...
  return (
    <div
      className={`${
        isOpen ? 'pop-up-container-open' : 'pop-up-container-close'
      }`}
    ...
    <button className={`${isDarkMode ? 'pop-up-close-btn-dark' :
      ...
      <div onClick={handlePopupContainerClick} className={`${isDarkMode?
        ...
        <div className={`${isDarkMode? 'form-parent-container-dark' :
        ...
        <form>
          ...
          <div className="job-title-parent-container">
            ...
            <input
              ...
              id="jobTitle"
              className={`job-input ${
                errors.jobTitle ? 'job-input-error': ''}
          ...
          <div className="job-label-input-container">
            ...
            <input
              ...
              className={`job-input ${
                errors.companyName ? 'job-input-error': ''}
                ${isDarkMode ? 'job-input-dark' : ''}`}
            />
            {
              errors.companyName &&
          ...
          <div className="job-label-input-container">
            ...
            <input
              ...
              className={`job-input ${
                errors.industry ? 'job-input-error': ''}
                ${isDarkMode ? 'job-input-dark':
